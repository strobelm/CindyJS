...
function simplCase(input, expected) {
    ...
    it(title, () => {
        expect(simpl(parse(input))).toEqual(expected);
    });
}
...
describe("CindyScript tokenizer", () => {
    ...
    it("should reconstruct regular expression for unicode letters", () => {
        ...
        expect(esc(Parser.unicodeLetters)).toEqual(esc(
            (expected =
        ...
        expect(Parser.unicodeLetters).toEqual(expected);
    });
});
