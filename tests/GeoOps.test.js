...
describe("IntersectLC helper", () => {
    it("must not return null vector just because one result has x == 0", () => {
        ...
        expect(p1.value[0].value.real).toBeCloseTo(-4, 1e-12);
        expect(p1.value[0].value.imag).toBeCloseTo(0, 1e-12);
        expect(p1.value[1].value.real).toBeCloseTo(-3, 1e-12);
        expect(p1.value[1].value.imag).toBeCloseTo(0, 1e-12);
        expect(p2.value[0].value.real).toBeCloseTo(0, 1e-12);
        expect(p2.value[0].value.imag).toBeCloseTo(0, 1e-12);
        expect(p2.value[1].value.real).toBeCloseTo(-3, 1e-12);
        expect(p2.value[1].value.imag).toBeCloseTo(0, 1e-12);
    });
});
