...
evaluator.guess$1 = function(args, modifs) {
    ...
    function isInteger(a) {
        Number.isInteger(a);
        //return almostZero(Math.round(a) - a);
    }
    ...
    function flatten(p) {
        if (p.y === 1)
            return guessPrimitive(p.x);
        return guessPrimitive(p.x) + "/" + guessPrimitive(p.y);
    ...
    function cf(a, pp, n) {
        ...
        //            Double d = (Double) vals.elementAt(i);
        //            //    System.err.println("canvas"+(a-d.doubleValue()));
        //        }
        //vals.addElement(new Double(a));
        vals.push(a);

        if (n === 0) {
            //System.err.print("... "+a+" --> ");
            //System.err.println(a-Math.round(a));
            return false;
        }
        if (isInteger(a)) {
            pp.x = Math.round(a);
    ...
    function guess(a) {
	debugger;
        if (almostZero(a.value.imag)) {
            return guessPrimitive(a.value.real);
        } else if (almostZero(a.value.real)) {
            return sign(a.value.imag) + "i*" + guessPrimitive(abs(a.value.imag));
        } else {
            return "" + guessPrimitive(a.value.real) + sign(a.value.imag) + "i*" + guessPrimitive(abs(a.value.imag));
        }
    }
